  ...
  return (
    <div className="space-y-4">
      <h1 className='text-2xl text-center font-semibold font-sans mb-6 text-gray-700 dark:text-gray-300'>Account Setup</h1>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Username (required, min 4 characters)</label>
            <input
          ...
          {/* email */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Password (required, min 6 characters)</label>
            <input
           ...
           {/* phone number */}
           <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Confirm Password (must match password)</label>
            <input
