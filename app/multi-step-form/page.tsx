...
// form step
 const renderStep =()=>{
  ...
  // 
  return (
    <div className='dark:text-gray-300 mx-auto w-full bg-gradient-to-r from-gray-300 via-gray-500 to-gray-700 p-4 sm:p-2 min-h-screen flex justify-center items-center text-gray-300'>
